...
export const PageSVG = ({ ...props }) => (
  ...
  >
    <g>
      ...
      />
      <rect x="96" y="192" fill={props.fill} width="152" height="32" />
      <rect x="96" y="352" fill={props.fill} width="328" height="32" />
      <rect x="304" y="192" fill={props.fill} width="120" height="120" />
      <polygon
        fill={props.fill}
